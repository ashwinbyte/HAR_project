...
```
har-android-personalization/
│
├── android/HARApp/                  ← Complete Android Studio project
│   └── app/src/main/
│       ├── java/com/har/app/
│       │   ├── MainActivity.java
│       │   ├── InferenceActivity.java
...
│
├── scripts/
│   ├── 01_preprocess.py             ← Load WISDM, window, normalize, split
│   ├── 02_train.py                  ← Train 1D-CNN, save model.keras
│   ├── 03_export_tflite.py          ← Export FP32 and INT8 TFLite models
│   └── 04_experiments.py            ← Run all 4 experiments
│
├── models/
│   ├── model_fp32.tflite            ← Full precision model (0.106 MB)
│   └── model_int8.tflite            ← Quantized model (0.037 MB)
│
├── data/
│   ├── README.md                    ← Instructions to download WISDM
│   └── label_classes.npy            ← Activity label encoder
│
├── outputs/
│   ├── figures/
...
│   └── results/
│       ├── exp1_baseline.json
│       ├── exp2_domainshift.json
│       ├── exp3_personalization.json
│       └── exp4_quantization.json
│
├── report/
│   └── CS655_Final_Report.pdf       ← Full ACM-format project report
│
├── .gitignore
└── README.md
```
